...
local urlencodedemo = '{"multipleRound":"S","flightintl_startcity_single":"广州(CAN)|32|GUANGZHOU，CHINA","flightintl_arrivalcity_single":"首尔(SEL)|274|SEOUL，SOUTH KOREA","flightintl_startdate_single":"2014-05-01","moreflightMin":3}'
print("--------------")
